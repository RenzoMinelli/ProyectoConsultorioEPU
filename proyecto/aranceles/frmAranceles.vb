Public Class frmAranceles
    ...
    Private Sub Aranceles_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            Consulta = " select id_a, descripcion from aranceles where id_a in (select id_a from plan_tratamiento p inner join cita c on c.id_c = p.id_c where month(fecha) = '" + fecha.ToString("MM") + "' and year(fecha) = '" + fecha.ToString("yyyy") + "') ;"
            consultar()
